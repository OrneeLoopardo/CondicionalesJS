//LOCAL STORAGE
/*localStorage.setItem("número", "6");
localStorage.setItem("valor", "true");
localStorage.setItem("arreglo", [1,2,3,4,5]);
localStorage.setItem("objeto", {nombre: "ornella", edad: 21});
...
//PARA BORRAR
/*localStorage.removeItem("número");// eliminar un elemento del Storage
sessionStorage.removeItem("nombre");

localStorage.clear(); //elimina el Storage por completo
...
localStorage.setItem("objeto", JSON.stringify({nombre: "ornella", edad: 21}));*/
